<template>
	<view>
		...
		<divider></divider>
		<uni-list-item showExtraIcon clickable leftIconStyle="color:#FDBF2E;" 
		leftIcon="icon-VIP" title="小米会员"></uni-list-item>
		<uni-list-item showExtraIcon clickable leftIconStyle="color:#FCBE2D;"
		leftIcon="icon-huangguan" title="会员中心"></uni-list-item>
		<uni-list-item showExtraIcon clickable leftIconStyle="color:#FA6C5E;"
		leftIcon="icon-service" title="服务中心"></uni-list-item>
		<uni-list-item showExtraIcon clickable leftIconStyle="color:#FE8B42;"
		leftIcon="icon-home" title="小米之家"></uni-list-item>
		<uni-list-item showExtraIcon clickable leftIconStyle="color:#9ED45A;"
		leftIcon="icon-gengduo" title="更多功能"></uni-list-item>
		<divider></divider>
		<uni-list-item showExtraIcon clickable leftIconStyle="color:#808C98;"
		leftIcon="icon-icon_set_up" title="更多设置" @click="navigate('user-set')"></uni-list-item>
	</view>
</template>
