<template>
	<view>
		<view class="p-2">
			...
			<view class="d-flex flex-wrap pt-2" style="margin-right: -20rpx;">
				<view class="px-2 py border rounded mr-2 mb-2 cate-item" v-for="(item,index) in cateList" :key="index"
					:class="cateIndex === index ? 'active':''" @tap="cateChange(index)">
					{{item.name}}
				</view>
			</view>
		</view>
		...
		<view class="p-2 d-flex a-start border-bottom border-light-secondary">
			<image src="../../static/demo/demo5.jpg" mode="widthFix" style="width: 90rpx;height: 90rpx;"
				class="rounded flex-shrink"></image>
			<view class="pl-2 flex-1">
				<view class="d-flex a-center">
					<text class="font-md text-primary font-weight">罗喵喵</text>
				...
				<view class="row">
					<view class="span24-8 px pb">
						<image src="../../static/demo/cate_09.png" mode="widthFix"
