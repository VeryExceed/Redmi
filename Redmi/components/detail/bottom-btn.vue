<template>
	<view>
		...
		<view class="d-flex a-stretch bg-white position-fixed left-0 bottom-0 right-0"
			...
			<view class="position-relative flex-1 d-flex flex-column a-center j-center line-h-md"
			...
			<view class="d-flex j-center a-center font-md main-bg-color text-white" hover-class="main-bg-color"
