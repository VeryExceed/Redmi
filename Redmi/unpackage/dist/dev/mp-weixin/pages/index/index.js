...
/* 16 */
/*!***************************************************************!*\
  !*** D:/Redmi/Redmi/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \***************************************************************/
...
/* 17 */
/*!********************************************!*\
  !*** D:/Redmi/Redmi/pages/index/index.vue ***!
  \********************************************/
/*! no static exports found */
...
/* 18 */
/*!***************************************************************************!*\
  !*** D:/Redmi/Redmi/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \***************************************************************************/
...
/* 19 */
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/Redmi/Redmi/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 20 */
/*!*********************************************************************!*\
  !*** D:/Redmi/Redmi/pages/index/index.vue?vue&type=script&lang=js& ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...

{
  ...
  onLoad: function onLoad() {var _this = this;
    ...
    uni.getSystemInfo({
      success: function success(res) {
        ...
        _this.scrollH = res.windowHeight - uni.upx2px(82) - navbarH; //upx 换算为 px
      } });
  ...
  methods: {
    ...
    __init: function __init() {var _this2 = this;
      // 获取顶部选项卡
      this.$H.get('/index_category/data').then(function (res) {
    ...
    // 加载数据
    addData: function addData() {var _arguments = arguments,_this3 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var callback, index, obj, id, page, data;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:callback = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : false;
                // 拿到当前索引
                index = _this3.tabIndex;
                obj = _this3.newsitems[index];
                // 拿到当前分类id
                id = _this3.tabBars[index].id;
                // 拿到当前分类的分页数
                page = Math.ceil(obj.list.length / 5) + 1;
                // 请求前
                if (page === 1) {
                  obj.loadtext = 'ing';
                }
                // 请求数据库
                _context.next = 8;return _this3.$H.get('/index_category/' + id + '/data/' + page);case 8:data = _context.sent;
                // 请求完数据
                if (page === 1) {
                  obj.firstLoad = 'after';
                }
                ...
                if (data) {
                  // 赋值
                  obj.list = [].concat(_toConsumableArray(obj.list), _toConsumableArray(data));
